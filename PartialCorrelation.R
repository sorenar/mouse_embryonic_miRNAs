...
# Reading the design matrix and sample file
...
#averaging the expressions for each cluster over each sample point
...
#calculating the standard deviations for each cluster across different stages                                   
...
# drawing the tissue specificity heatmap
library("gplots")
...
# calculating the partial correlations between miRNA clusters and mRNA clusters
...
# drawing the heatmap for the partial correlation matrix
